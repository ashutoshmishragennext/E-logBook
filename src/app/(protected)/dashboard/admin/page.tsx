...
import AdminTemplatesDashboard from "@/components/adminComponent/TemplatesDisplay";
  ...
  },
  {
    ...
    subItems: [
      ...
      // },
      {
        ...
        label: "Templates",
        component: <AdminTemplatesDashboard/>}
    ],
  },
];
      ...
      >
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 h-16 flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="relative profile-dropdown">
            ...
            {/* Dropdown menu - Fixed styling */}
            {profileDropdownOpen && (
              <div
                className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 border border-gray-200 z-10 profile-dropdown"
              >
                <button
            ...
            <div key={item.id}>
              <button
                ...
                className={`w-full flex items-center justify-between gap-3 px-3 py-2 rounded-lg transition-colors ${
                  ...
                  (item.subItems &&
                    item.subItems.some((sub) => sub.id === activeComponent))
