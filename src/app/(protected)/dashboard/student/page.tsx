...
import LogBookEntries from "@/components/studentComponent/LogBookEntries";
...
const Sidebar = () => {
  ...
  const sidebarItems = [
    ...
    { id: "logBookentries", label: "Log Book Entries", icon: <School size={20} />, component: <LogBookEntries/> },
  ];
