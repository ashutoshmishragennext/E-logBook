...
const SubjectAssignment: React.FC<SubjectAssignmentProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-theme shadow-lg w-4/5 max-w-6xl max-h-[80vh] overflow-hidden flex flex-col">
        {/* Header */}
        ...
        <div className="flex flex-1 overflow-hidden">
          ...
          <div className="w-[70%] p-6 overflow-y-auto border-r">
            <div className="mb-6">
              ...
              <div className="bg-gray-50 p-4 rounded-theme shadow-sm">
            ...
            <div>
              <div className="flex items-center mb-3">
                ...
                <span className="ml-2 bg-blue-100 text-blue-800 text-xs font-medium px-2.5 py-0.5 rounded-theme">
              ...
              {assignedSubjects.length === 0 ? (
                <div className="bg-gray-50 p-4 rounded-theme text-center">
                  <p className="text-gray-500 italic">
                    No subjects currently assigned
                  </p>
                </div>
              ) : (
                <div className="overflow-x-auto bg-white rounded-theme border shadow-sm">
          ...
          <div className="w-[30%] p-6 overflow-y-auto bg-gray-50">
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 text-red-800 px-4 py-3 rounded-theme mb-4 flex items-start">
            ...
            {status && (
              ...
              <div
                ...
                } border px-4 py-3 rounded-theme mb-4 flex items-start`}
              >
                {status.includes("✅") ? (
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border rounded-theme focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                {selectedSubjectIds.length > 0 && (
                  <div className="mt-2">
                    ...
                    <div className="max-h-32 overflow-y-auto border rounded-theme bg-white p-2">
                      {selectedSubjectIds.map((subjectId) => {
                        ...
                        return (
                          <div
                            key={subjectId}
                            className={`flex items-center justify-between py-1 px-2 rounded-theme ${
                          ...
                          >
                            ...
                            {isAssigned && (
                              <span className="inline-flex items-center text-xs font-medium text-blue-700 bg-blue-100 px-2 py-0.5 rounded-theme">
              ...
              <button
                ...
                className="w-full bg-blue-600 text-white py-2 rounded-theme hover:bg-blue-700 transition disabled:bg-blue-400 flex items-center justify-center"
              >
                {isLoading ? (
                  <>
        ...
        {showConfirmation && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-theme shadow-lg w-96 p-6 max-h-[80vh] overflow-y-auto">
              ...
              <div className="flex justify-end space-x-3">
                <button
                  ...
                  className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-theme"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-theme"
                >
                  Proceed
                </button>
              </div>
