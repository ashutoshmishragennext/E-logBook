          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <span className="text-xl font-bold">Med<span className="text-blue-400">eLog</span></span>
              </div>
              <p className="text-gray-400">Secure, efficient document management </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <Link href="/documentation" className="block text-gray-400 hover:text-white">Documentation</Link>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <Link href="/gdpr" className="block text-gray-400 hover:text-white">GDPR Compliance</Link>
                <Link href="/accessibility" className="block text-gray-400 hover:text-white">Accessibility</Link>
              </div>
            </div>
          </div>
          
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">© {new Date().getFullYear()} Medelog. All rights reserved.</p>
